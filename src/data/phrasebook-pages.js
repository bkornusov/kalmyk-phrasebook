var phraseBookPages = [
  ...
  },
  {
    ...
    dialog: [
      ...
      },
      {
        ...
        russian: "Амуланг: Немного подожди.",
      },
      {
        audio: "ch7/7-04.mp3",
  ...
  },
  {
    ...
    dialog: [
      ...
      },
      {
        ...
        russian: "Амуланг: Мне русский черный чай.",
      },
    ],
    vocabulary: [
      { audio: "ch8/8-09.mp3", kalmyk: "цә", russian: "чай" },
      { audio: "ch8/8-10.mp3", kalmyk: "уух", russian: "пить" },
      { audio: "ch8/8-11.mp3", kalmyk: "орс", russian: "русский" },
      { audio: "ch8/8-12.mp3", kalmyk: "үсн", russian: "молоко" },
      { audio: "ch8/8-13.mp3", kalmyk: "цә кех", russian: "наливать чай" },
  ...
  },
  {
    ...
    vocabulary: [
      { audio: "ch9/9-09.mp3", kalmyk: "хаш", russian: "каша" },
      { audio: "ch9/9-10.mp3", kalmyk: "тутрһ", russian: "рис" },
      { audio: "ch9/9-11.mp3", kalmyk: "дурта", russian: "любить" },
      { audio: "ch9/9-12.mp3", kalmyk: "өндгн", russian: "яйцо" },
      { audio: "ch9/9-13.mp3", kalmyk: "чамд", russian: "тебе, тебя" },
      { audio: "ch9/9-14.mp3", kalmyk: "шарх", russian: "жарить" },
  ...
  },
  {
    chapter: 10,
    pageNumber: 10,
    title: "10. Сурһульдан белдлһн / Подготовка к школе",
    dialog: [
      {
      ...
      },
      {
        ...
        kalmyk: "Саглара: Өмсчәнәв.",
        russian: "Саглара: Надеваю.",
      },
    ],
    vocabulary: [
      { audio: "ch10/10-09.mp3", kalmyk: "авх", russian: "брать" },
      { audio: "ch10/10-10.mp3", kalmyk: "белдх", russian: "готовить" },
      { audio: "ch10/10-11.mp3", kalmyk: "девтр", russian: "тетрадь" },
      { audio: "ch10/10-12.mp3", kalmyk: "дегтр", russian: "книга" },
      { audio: "ch10/10-13.mp3", kalmyk: "дорв", russian: "сумка" },
      { audio: "ch10/10-14.mp3", kalmyk: "өмсх", russian: "надевать" },
    ...
    extras: {
      items: [
        ...
        "Вопросительная частица -в добавляетя после суффикса -в недавнопрошедшего времени. В некоторых случаях суффикс времени -в заменяется на -у/ү, если подряд идут две или три буквы «в». Если основа глагола оканчивается на гласную букву, две буквы «в» сохраняются (уу – уувв, ууввч, ууввт).",
      ],
    },
    highlights: {
      dialog: {
  ...
  },
  {
    ...
    extras: {
      items: [
        "Существительные, оканчивающиеся на суффикс совместного падежа -та/тә, отвечают на вопросы с кем? с чем? ",
      ],
    },
    highlights: {
      dialog: { red: ["та"], blue: [] },
  ...
  },
  {
    ...
    dialog: [
      ...
      },
      {
        ...
        russian: "Саглр: Хороший сон видела.",
      },
    ],
    vocabulary: [
  ...
  },
  {
    ...
    dialog: [
      ...
      },
      {
        ...
        russian: "Аав: Пусть (пища) станет нектаром!",
      },
      {
  ...
  },
  {
    ...
    dialog: [
      ...
      },
      {
        ...
        russian: "Амуланг: Меня учитель тоже похвалил.",
      },
      {
  ...
  },
  {
    ...
    dialog: [
      ...
      },
      {
        ...
        russian: "Ээҗ: Есть бериги. Есть булмук.",
      },
      {
      ...
      },
      {
        ...
        russian: "Саглр: Я буду пить молочный чай.",
      },
      {
    ...
    dialog: [
      {
        ...
        russian: "Амуланга: Саглара, вам какое домашнее задание давали.",
      },
      {
        audio: "ch18/18-03.mp3",
        kalmyk: "Саглр: Маднд нег эсв, нег үлгүр өглә.",
        russian: "Саглр: Нам задавали одну задачу, один пример.",
      },
      {
      ...
      },
      {
        ...
        russian: "Амуланга: Что еще тебе нужно делать?",
      },
      {
  ...
  },
  {
    ...
    dialog: [
      ...
      },
      {
        ...
        russian: "Папа: Ты тоже такая умная. Сейчас спи.",
      },
      {
  ...
  },
  {
    ...
    dialog: [
      ...
      },
      {
        ...
        russian: "Саглр: Папа, а тебе сколько лет?",
      },
      {
        ...
        russian:
          "Аав: Мне сорок. По-калмыцки мне сорок один. Родившийся ребенок считается годовалым.",
      },
      {
        audio: "ch21/21-06.mp3",
        kalmyk: "Амулӊ: Тиигхлә эндр дөчн хойрта болхч?",
        russian: "Амуланг: Тогда тебе будет сорок два?",
      },
      {
      ...
      },
      {
        ...
        russian: "Саглр: А сколько мне будет лет?",
      },
      {
      ...
      },
      {
        ...
        russian:
          "Ээҗ: Ну что ж, произнесем благопожелания нашему возрасту и попьем чай с борцоками.",
      },
      {
  ...
  },
  {
    ...
    extras: {
      items: [
        "Значение множественности в именах существительных передается при помощи специальных суффиксов множественного числа. Вот некоторые из них: (-д, -уд/-үд, -муд/-мүд). Суффикс -д прибавляется к основе слова, оканчивающегося на согласный «н»: одн (звезда) – одд (звезды), нерн (имя) – нерд (имена). Конечный согласный «н» при этом выпадает. Суффикс -уд/-үд – прибавляется к основе слова, оканчивающегося на согласный «г»: һарг (планета)-һаргуд (планеты); суффикс -муд/-мүд – прибавляется к основе слова, оканчивающегося на другие согласный: өдр (день) - өдрмүд (дни). О суффиксе -нр мы уже писали в теме 1. Мендллһн. Таньлдлһн» и теме 23. Һарсн өдрин байр.",
      ],
    },
    highlights: {
      dialog: {
  ...
  },
  {
    ...
    items: [
      ...
      { kalmyk: "белдх (10)", russian: "готовить" },
